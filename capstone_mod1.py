...
# Untuk memasukkan/menambah data Buku baru
...
# Untuk mengupdate data Buku yang telah ada
...
# Untuk menghapus data Buku yang telah ada
...
def beli():
    index = input('Masukkan index buku yang ingin dibeli: ')
    if (int(index) > len(list_buku)-1):
            print('Informasi buku tidak ditemukan!!\n')
            membeli_buku()
    else:
